...
export function makeMockSchema(archetype: SlideArchetype): SlideSchema {
  return {
    ...
    content: {
      ...
      semanticObjects: [
        { id: "o1", kind: "heading", role: "title", priority: 1, mustPreserve: true, rewriteAllowed: "light", visualWeight: "high", headline: "Q3 growth priorities" },
        { id: "o2", kind: "section", role: "body", priority: 3, mustPreserve: false, rewriteAllowed: "moderate", visualWeight: "medium", body: "Operationalize account health reviews." }
      ]
    },
    layout: {
      ...
      elements: [
        { id: "e-title", type: "text", contentRef: "o1", styleToken: "title_primary", x: 0.6, y: 0.5, w: 8, h: 0.9, zIndex: 1 },
        { id: "e-card-1", type: "card", contentRef: "s1", styleToken: "card_feature", x: 0.6, y: 1.7, w: 5.9, h: 2.1, zIndex: 2 },
        { id: "e-card-2", type: "card", contentRef: "s2", styleToken: "card_neutral", x: 6.7, y: 1.7, w: 5.9, h: 2.1, zIndex: 2 }
      ]
    }
  };
}
